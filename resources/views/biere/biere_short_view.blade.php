<div id="short_biere_view_{{ $biere->id_biere }}">
	<a href="../biere/{{{ $biere->id_biere }}}">{!! Html::image((asset("assets/img/bieres/$biere->id/$biere->etiquette")), "Logo $biere->nom_biere", array("width" => "70;", "align" => "left")) !!}</a>
	...
	@endif
	{!! asset('assets/img/bieres/' + $biere->id_biere + '/' + $biere->etiquette) !!}
</div>
